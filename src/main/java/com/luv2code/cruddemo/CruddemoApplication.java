...
//			deleteStudentById(studentDAO);
	...
	private void deleteAllStudentRecords(StudentDAO studentDAO) {
		...
		System.out.println("Are you sure to delete all student records " +
				"(Respond 'Yes' to confirm deletion)");
		String response = scanner.nextLine();
		if(response.equalsIgnoreCase("Yes")) {
			int rowDeleted = studentDAO.deleteAll();
			System.out.println(rowDeleted + " rows of student data deleted.");
		}
	...
	private void deleteStudentById(StudentDAO studentDAO) {
		...
		System.out.println("Student id: " + student.get().getId() + " has been " +
